...
tuples=(
    ...
    "20, sam, 0.01, 1, TensorRing, 10"
    "20, sam, 0.05, 1, TensorRing, 10"
    "20, sam, 0.1, 1, TensorRing, 10"
    "20, sam, 0.5, 1, TensorRing, 10"


    "20, sam, 0.01, 1, TensorRing, 20"
    "20, sam, 0.05, 1, TensorRing, 20"
    "20, sam, 0.1, 1, TensorRing, 20"
    "20, sam, 0.5, 1, TensorRing, 20"
    ...
    "20, sam, 0.01, 1, CP, 100"
    "20, sam, 0.05, 1, CP, 100"
    "20, sam, 0.1, 1, CP, 100"
    "20, sam, 0.5, 1, CP, 100"

    # "20, sgd, 0, 1, Tucker, 10"
    # "20, sgd, 0, 1, Tucker, 20"
    "20, sam, 0.01, 0, None, 0"
    "20, sam, 0.05, 0, None, 0"
    "20, sam, 0.1, 0, None, 0"
    "20, sam, 0.5, 0, None, 0"
)
